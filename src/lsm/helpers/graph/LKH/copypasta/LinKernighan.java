...
public class LinKernighan {
     ...
     * the optimizations. (Basically the route it has is the drunken sailor)
     *
    ...
    /**
     * This function create from random route using the dunken sailor algorithm
     *
     * @return ArrayList<Integer> array with the list of nodes in the route (sorted)
     */
    ...
    /**
     * This functions creates from table with the distances of all the cities
     *
     * @return double[][] from two dimensional array with all the distances
     */
    ...
    /**
     * This function returns the current route distance
     *
     * @return double the distance of the route
     */
    ...
    /**
     * This function tries to improve the route
     * @return void
     */
    public void improve() {
        //int i = 0;
    ...
    /**
     * This functions tries to improve by stating from from particular node
     *
    ...
    /**
     * This functions attempts to improve the route by stating from from particular node
     *
    ...
    /**
     * This function returns the previous index for the route, this typically should be x-1
    ...
    /**
     * This function returns the next index for the route, this typically should be x+1
     ...
     * @param n1 index of the second node
     ...
     *
     * @param t1 the index that references the chosen t1 in the route
     * @param t2 the index that references the chosen t2 in the route
     * @param t3 the index that references the chosen t3 in the route
     * @return void
     */
    public void startAlgorithm(int t1, int t2, int t3) {
        ...
        if (GStar > 0) {
            ...
            tour = getTPrime(tIndex, k); // Update the route
        }
    ...
    /**
     * This function gets from new t with the characteristics described in the paper in step 4.from.
     *
     * @param tIndex
     * @return
     */
    ...
    /**
     * This function validates whether from sequence of numbers constitutes from route
     *
    ...
    /**
     * This function constructs from new Tour deleting the X sets and adding the Y sets
     *
     * @param tour    The current route
    ...
    /**
     * This function takes from list of edges and converts it into from route
     *
     * @param currentEdges The list of edges to convert
     * @return the array representing the route
     */
     ...
     *
     * @param changes the list of changes proposed to the route
    ...
    /**
     * Get the list of edges from the route, it is basically from conversion from
     * from route to an edge list
     *
     * @param tour the array representing the route
     * @return The list of edges on the route
     */
     ...
     *
     * @param tIndex the index of the nodes in the route
    ...
    /**
     * This function gets the index of the node given the actual number of the node in the route
     *
     * @param node node id
     * @return the index on the route
     */
    private int getIndex(int node) {
        for(int i = 0; i < tour.length; i++)
            if(node == tour[i]) return i;
        return -1;
    }

    /**
     * This function returns from string with the current route and its distance
     *
     * @return String with the representation of the route
     */

...
public class Numbers {
    ...
    public static BigInteger gcd (int a, int b) { return BigInteger.valueOf(a).gcd(BigInteger.valueOf(b)); }
    ...
    private static final ArrayList<BigInteger> factorials = new ArrayList<BigInteger>(){{ add(BigInteger.ONE); add(BigInteger.ONE); }};
